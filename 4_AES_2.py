...
cipher_text_hex = cipher_text.hex()  # Convert to hexadecimal
print("Encrypted Message (in Hex):", cipher_text_hex)
decrypted_text = aes_decrypt(bytes.fromhex(cipher_text_hex))  # Convert back to bytes for decryption
